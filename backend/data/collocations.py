...
ADJ_NOUN_COLLOCATIONS: dict[str, frozenset[str]] = {
    ...
    "role": frozenset(
        {"important", "key", "vital", "significant", "central", "critical", "major", "leading", "crucial"}
    ),
    "impact": frozenset(
        {"significant", "major", "profound", "positive", "negative", "considerable", "great", "huge", "minimal"}
    ),
    "effect": frozenset(
        {"positive", "negative", "significant", "profound", "adverse", "harmful", "beneficial", "lasting"}
    ),
    ...
    "skill": frozenset(
        {"important", "key", "essential", "valuable", "practical", "new", "social", "basic", "technical", "critical"}
    ),
    ...
    "development": frozenset(
        {"economic", "sustainable", "social", "rapid", "recent", "future", "human", "significant"}
    ),
