...
_US_TO_UK: Dict[str, str] = {
    # -our / -or
    "color": "colour", "honor": "honour", "favor": "favor",
    "behavior": "behaviour", "neighbour": "neighbor",
    "harbor": "harbour", "humor": "humour", "labor": "labour",
    "rumor": "rumour", "flavor": "flavour", "tumor": "tumour",
    "vapor": "vapour", "armor": "armour", "odor": "odour",
    # -ize / -ise
    "organize": "organise", "recognize": "recognise", "realize": "realise",
    "analyze": "analyse", "apologize": "apologise", "emphasize": "emphasise",
    "criticize": "criticise", "authorize": "authorise",
    "characterize": "characterise", "specialize": "specialise",
    "summarize": "summarise", "utilize": "utilise", "mobilize": "mobilise",
    "legalize": "legalise", "normalize": "normalise", "modernize": "modernise",
    "stabilize": "stabilise", "visualize": "visualise",
    "minimize": "minimise", "maximize": "maximise", "finalize": "finalise",
    "prioritize": "prioritise", "customize": "customise",
    "digitize": "digitise", "memorize": "memorise",
    # -er / -re
    "center": "centre", "theater": "theatre", "meter": "metre",
    "fiber": "fibre", "liter": "litre", "specter": "spectre",
    "somber": "sombre", "caliber": "calibre",
    # -se / -ce
    "defense": "defence", "offense": "offence", "license": "licence",
    "pretense": "pretence",
    # misc
    "program": "programme", "catalog": "catalogue", "dialog": "dialogue",
    "analog": "analogue", "check": "cheque", "tire": "tyre",
    "curb": "kerb", "gray": "grey", "jewelry": "jewellery",
    "mustache": "moustache", "plow": "plough", "draft": "draught",
    "favorite": "favourite", "aging": "ageing",
}
